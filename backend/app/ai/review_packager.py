...
async def generate_review_package(
    ...
    # Combine applicant data, form fields, and programme info into one blob
    # that each prompt template receives as {{ full_application_json }}
    full_app_context = {
    ...
    # Summary → summary_text (stringify the structured summary for storage)
    ...
    # Scoring → suggested_scores dict {dimension: score}
